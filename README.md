...
1. Download glscript-language-server [from Release page](https://github.com/etherealHero/glscript-language-server/releases) and move it to `<project_dir>/.local/glscript-language-server.exe`
